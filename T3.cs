...
public class T3 : mResources
{
  public static void load()
  {
    ...
    mResources.msgg = new string[2]{ "Pesan", string.Empty };
    ...
    {
      new string[2]{ "Quest", string.Empty },
      new string[2]{ "Inven-", "tory" },
      new string[2]{ "Skill", string.Empty },
    ...
    mResources.mainTab2 = new string[5][]
    {
      ...
      new string[2]{ "Inven-", "tory" },
      new string[2]{ "Skill", string.Empty },
      new string[2]{ "Clan", string.Empty },
      new string[2]{ "Func-", "tion" }
    };
    mResources.petMainTab = new string[3][]
    {
      new string[2]{ "Dis-", "ciple" },
      new string[2]{ "Status", string.Empty },
      new string[2]{ "Inven-", "tory" }
    };
    ...
    mResources.key_skill_qwerty = new string[10]
    {
      "Tambah\n1",
      "Tambah\n2",
      "Tambah\n3",
    ...
    mResources.mapp = new string[2]{ "Peta", string.Empty };
    ...
    mResources.zonee = new string[2]{ "Zona", string.Empty };
