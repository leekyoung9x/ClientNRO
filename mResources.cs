...
public class mResources
{
  ...
  {
    new string[3]{ string.Empty, string.Empty, string.Empty },
    new string[3]{ string.Empty, string.Empty, string.Empty },
    new string[3]{ string.Empty, string.Empty, string.Empty }
  };
  ...
  public static void loadLanguague() => mResources.loadLanguague((sbyte) 1);
  ...
  public static string replace(string str, string replacement) => NinjaUtil.replace(str, "#", replacement);
}
