...
public abstract class IPaint
{
  ...
  public abstract void paintInputTf(
    mGraphics g,
    bool iss,
    int x,
    int y,
  ...
  public abstract void paintMsgBG(
    mGraphics g,
    int x,
    int y,
    int w,
  ...
  public abstract void paintDefaultScrLisst(
    mGraphics g,
    string title,
    string subTitle,
    string check);
  ...
  public abstract void paintIconMainMenu(
    mGraphics g,
    int x,
    int y,
    bool iss,
  ...
  public string getFAQLink() => "http://wap.teamobi.com/faqs.php?provider=";
